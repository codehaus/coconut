...
/**
 * Interface realizing a visitor pattern for {@link ManagedGroup}. The visitor should visit the
 * group, its children, and all instantiated components within a group.
 * 
...
public interface ManagedVisitor<T> {
    ...
    /**
     * Entry point for the ManagedVisitor traversal. The given node is the first object, that is
     * asked for acceptance. Only objects of type {@link ManagedGroup}, or {@link Manageable} are
     * valid.
     * 
     * @param node
