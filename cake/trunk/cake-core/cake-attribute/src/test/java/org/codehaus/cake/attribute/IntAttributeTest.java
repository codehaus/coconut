...
public class IntAttributeTest extends AtrStubs {
    ...
    public void get() {
        ...
        assertEquals(100, LONG_A.get(withAtr(am)));
        assertEquals(-1, LONG_A.get(withAtr(am1)));
        assertEquals(10000, LONG_A.get(withAtr(am10000)));
        assertEquals(Integer.MAX_VALUE, LONG_A.get(withAtr(ammax)));

        assertEquals(10, LONG_A.get(withAtr(am), 10));
        assertEquals(-1, LONG_A.get(withAtr(am1), 10));
        assertEquals(10000, LONG_A.get(withAtr(am10000), 10));
        assertEquals(Integer.MAX_VALUE, LONG_A.get(withAtr(ammax), 10));
