...
@Suite.SuiteClasses( { CacheLoaderErroneous.class, ExpirationWithCacheLoader.class,
        ExplicitForcedLoading.class, ExplicitLoading.class, ImplicitLoading.class,
        LoadingCallback.class, LoadingIllegalAttributeValues.class, LoadingLazyStart.class,
