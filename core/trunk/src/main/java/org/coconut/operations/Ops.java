 ...
 * <p>
 * In addition to stated signatures, implementations of these interfaces must work safely
 * in parallel. In general, this means methods should operate only on their arguments, and
 * should not rely on ThreadLocals, unsafely published globals, or other unsafe
 * constructions. Additionally, they should not block waiting for synchronization.
 * <p>
 * This class also contains a few commonly used implementations of some of these
 * interfaces
 * <p>
...
// /CLOVER:OFF
    ...
    public static final class CompoundMapper<T, U, V> implements Mapper<T, V> {
        ...
        public CompoundMapper(Mapper<? super T, ? extends U> first,
