...
import org.coconut.cache.tck.testutil.CountdownLatchLoader;
...
public class ExpirationConcurrent extends ExpirationTestBundle {
    ...
    public void testStrict() throws InterruptedException {
        ...
        for (;;) {
            ...
            expiration().put(M1.getKey(), M1.getValue(), s, TimeUnit.NANOSECONDS);
    ...
    public void testStrictThreaded() throws InterruptedException {
        ...
        expiration().put(M1.getKey(), "ZXCW", 1, TimeUnit.NANOSECONDS);
