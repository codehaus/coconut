...
public class AttributeMaps_ImmutableMapTest extends AbstractAttributeMapTest {
    ...
    public void unmodifiableAttributeMap() {
        ...
        assertFalse(immutable.containsKey(dummy(Attribute.class)));
    ...
    public void serialization() throws Exception {
        assertIsSerializable(new Attributes.ImmutableAttributeMap(Attributes.singleton(
                SizeAttribute.INSTANCE, 123L)));
    }
}
