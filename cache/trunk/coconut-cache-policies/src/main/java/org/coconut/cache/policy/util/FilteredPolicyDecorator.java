...
//            long maximumSize) {
//        return new FilteredPolicyDecorator<T>(policy, new SizeFilter(maximumSize));
//    }
//
...
//    }
//
//    private final Filter<AttributeMap> filter;
//
//    /**
//     * @param policy
//     */
//    public FilteredPolicyDecorator(ReplacementPolicy<T> policy,
//            Filter<AttributeMap> filter) {
//        super(policy);
//        if (filter == null) {
...
//    }
//
//    static class CostFilter implements Filter<AttributeMap> {
...
//         */
//        public boolean accept(AttributeMap element) {
//            double cost = element.getDouble(PolicyAttributes.COST,
//                    ReplacementPolicy.DEFAULT_COST);
//            return cost >= minimumCost;
//        }
//    }
//
//    static class SizeFilter implements Filter<AttributeMap> {
...
//         */
//        public boolean accept(AttributeMap element) {
//            long size = element.getLong(PolicyAttributes.SIZE,
