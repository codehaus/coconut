...
import org.coconut.management2.spi.AbstractPassiveMonitor;

/**
 * @author <a href="mailto:kasper@codehaus.org">Kasper Nielsen</a>
 * @version $Id: Cache.java,v 1.2 2005/04/27 15:49:16 kasper Exp $
 */
public class EnumCountMonitor<T extends Enum> extends AbstractPassiveMonitor implements
        EventProcessor<T>, Serializable {
    ...
    public EnumCountMonitor(Class<? extends Enum> e, String name) {
        this(e, name, "Amount of handled " + e + "s");
    }

    public EnumCountMonitor(Class<? extends Enum> e, String name, String description) {
    ...
    final class EnumNumber extends Number implements Callable<Number>, Named, Described {
        ...
        public String getDescription() {
            return EnumCountMonitor.this
                    .getDescription(clazz.getEnumConstants()[ordinal]);
        }
