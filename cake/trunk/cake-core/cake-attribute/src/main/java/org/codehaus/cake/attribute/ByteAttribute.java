...
public abstract class ByteAttribute extends Attribute<Byte> implements
    ...
    /**
     * Creates a new ByteAttribute with a generated name and a default value of <tt>$defaultValueNoCast</tt>.
     * 
    ...
    /**
     * Creates a new ByteAttribute with a default value of <tt>$defaultValueNoCast</tt>.
     * 
     * @param name
     ...
     * @throws IllegalArgumentException
     *             if $defaultValueNoCast is not a valid value according to {@link #checkValid(byte)}
     */
