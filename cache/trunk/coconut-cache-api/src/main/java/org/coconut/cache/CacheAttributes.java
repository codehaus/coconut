...
public class CacheAttributes implements PolicyAttributes {
	...
	/**
     * This key can be used to indicate that how long time a cache entry should
     * live before it expires. The time-to-live value should be a long and
     * should be measured in nano seconds. Use
     * {@link java.util.concurrent.TimeUnit} to convert between different time
     * units.
     */
