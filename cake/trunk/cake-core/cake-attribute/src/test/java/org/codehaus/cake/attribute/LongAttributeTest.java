...
public class LongAttributeTest extends AtrStubs {
    ...
    public void get() {
        ...
        assertEquals(100L, LONG_A.get(withAtr(am)));
        assertEquals(-1l, LONG_A.get(withAtr(am1)));
        assertEquals(10000l, LONG_A.get(withAtr(am10000)));
        assertEquals(Long.MAX_VALUE, LONG_A.get(withAtr(ammax)));
        assertEquals(10000l, LONG_A.get(withAtr(am10000)));
        assertEquals(Long.MAX_VALUE, LONG_A.get(withAtr(ammax)));

        assertEquals(10L, LONG_A.get(withAtr(am), 10L));
        assertEquals(-1l, LONG_A.get(withAtr(am1), 10));
        assertEquals(10000l, LONG_A.get(withAtr(am10000), 10));
        assertEquals(Long.MAX_VALUE, LONG_A.get(withAtr(ammax), 10));
        assertEquals(10000l, LONG_A.get(withAtr(am10000), 10));
        assertEquals(Long.MAX_VALUE, LONG_A.get(withAtr(ammax), 10));

        assertEquals(-1l, NON_NEGATIVE.get(withAtr(am), -1));
    }
    ...
    public void setNPE() {
        LONG_A.set((AttributeMap) null, 1L);
    }
