 ...
 */
public class ConcurrentLinkedQueue<E> implements ConcurrentReplacementPolicy<E>,
     ...
     * Similarly, iteration methods ignore those with nulls. Also note that like
     * most non-blocking algorithms in this package, this implementation relies
     * on the fact that in garbage collected systems, there is no possibility of
     * ABA problems due to recycled nodes, so there is no need to use "counted
     * pointers" or related techniques seen in versions used in non-GC'ed
     * settings.
     */
    ...
    private static class Node<E> {
        ...
        Object getAndSetItem(E val) {
            return itemUpdater.getAndSet(this, val);
        }
    ...
    public void touch(Object o) {
        Node n = (Node) o;
        E value;
        if ((value = (E) n.getAndSetItem(null)) != null) {
            add(value);
        }
    }
     ...
     * throw {@link ConcurrentModificationException}, and guarantees to
     ...
     * 
     * @serialData All of the elements (each an <tt>E</tt>) in the proper
    ...
    /**
     * @see org.coconut.cache.policy.concurrent.ConcurrentReplacementPolicy#clear()
     */
    public void clear() {
    ...
    /**
     * @see org.coconut.cache.policy.concurrent.ConcurrentReplacementPolicy#update(java.lang.Object,
     *      java.lang.Object)
     */
    public boolean update(Object index, E newElement) {
        Node<E> p = (Node<E>) index;
        for (;;) {
            E e = p.getItem();
            if (e != null) {
                if (p.casItem(e, newElement)) {
                    break;
                }
            } else {
                break;
    ...
    /**
     * @see org.coconut.cache.policy.concurrent.ConcurrentReplacementPolicy#peekAll()
     */
