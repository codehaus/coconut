...
public abstract class LongAttribute extends Attribute<Long> implements
    ...
    /**
     * Creates a new LongAttribute with a generated name and a default value of <tt>$defaultValueNoCast</tt>.
     * 
     ...
     * @throws IllegalArgumentException
     *             if $defaultValueNoCast is not a valid value according to {@link #checkValid(long)}
     */
