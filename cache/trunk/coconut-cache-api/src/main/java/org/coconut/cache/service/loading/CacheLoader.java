 ...
 * will then insert the key-value pair into the cache and return the value. The cache
 * loader might also be used to fetch an updated value when an entry has expired.
 * <p>
