...
public class CacheManagementConfiguration<K, V> extends
     ...
     * domain is specified the cache will use
	...
	/**
     * Sets whether or not management is enabled for the cache. The default
	...
	/**
     * Sets a ManagedGroupVisitor that will used to register all the. Normal
     * users will seldom need to use this method. But if you need some kind of
     * non standard naming of {@link javax.management.ObjectName ObjectNames},
     * wants to only register a specific cache service or any other special
     * thing. You can use this method to specify a special registrant that will
     * visit each cache service.
     * <p>
	...
	/**
     * Sets that ManagedGroup that each cache service will register with. Normal
     * usage of this cache does not involve using this method. But if you need
     * to do something crazy you can use this method.
     * 
     * @param root
     * @see #getRoot()
     */
