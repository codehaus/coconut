 ...
 * <ul>
 * <li> <strong>Item events</strong>, which concerns a particular key-value pair in the
 * cache. For example, an event indicating that a particular key-value has been removed.
 * Item events all inherit from {@link CacheItemEvent}.
 ...
 * removed. These all inherit from {@link CacheEvent}.
 * </ul>
 * <p>
...
public interface CacheEvent<K, V> {
    ...
    // AttributeMap getEventAttributes();
    /**
