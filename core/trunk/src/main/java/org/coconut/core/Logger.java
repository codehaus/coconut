 ...
 * for coconut-cache is to avoid dependencies on any external logging libraries.
 * <p>
 * Use {@link org.coconut.core.Loggers}to create wrappers from popular logging frameworks
 * such as <a
