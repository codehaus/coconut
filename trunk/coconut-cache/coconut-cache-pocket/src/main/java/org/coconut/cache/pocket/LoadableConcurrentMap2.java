 ...
 */
public class LoadableConcurrentMap2<K, V> extends AbstractMap<K, V> implements
    ...
    static final class Segment<K, V> extends ReentrantLock implements Serializable {
        ...
        V get(Object key, int hash, boolean block) {
        ...
        V replace(K key, int hash, V newValue) {
            ...
            try {
                ...
                if (e != null) {
                    ...
                    // ***MOD***
                    if (oldValue == null) {
                        // Check to see if we can release some who is waiting on
                        // the value
                        // also check to see if we want to interrupt the loader
                    }
                    // ***MOD***
                }
                return oldValue;
     ...
     */
    public LoadableConcurrentMap2(int initialCapacity, float loadFactor,
     ...
     */
    public LoadableConcurrentMap2(int initialCapacity) {
     ...
     *            the map
     */
    public LoadableConcurrentMap2(Map<? extends K, ? extends V> m) {
    ...
    abstract class HashIterator {
        ...
        public void remove() {
            ...
            LoadableConcurrentMap2.this.remove(lastReturned.key);
            lastReturned = null;
        }
    }
    ...
    final class WriteThroughEntry extends org.coconut.internal.util.SimpleEntry<K, V> {
        ...
        public V setValue(V value) {
            ...
            LoadableConcurrentMap2.this.put(getKey(), value);
            return v;
        }
    }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        public int size() {
            return LoadableConcurrentMap2.this.size();
        }

        public boolean contains(Object o) {
            return LoadableConcurrentMap2.this.containsKey(o);
        }

        public boolean remove(Object o) {
            return LoadableConcurrentMap2.this.remove(o) != null;
        }

        public void clear() {
            LoadableConcurrentMap2.this.clear();
        }
    }
    ...
    final class Values extends AbstractCollection<V> {
        ...
        public boolean contains(Object o) {
            return LoadableConcurrentMap2.this.containsValue(o);
        }
    ...
    final class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        public boolean contains(Object o) {
            ...
            Object key = e.getKey();
            int hash = hash(key.hashCode());
            V v = segmentFor(hash).get(key, hash, false);
            // *** MOD ***
            // V v = LoadableConcurrentMap2.this.get(e.getKey());
        ...
        public boolean remove(Object o) {
            if (!(o instanceof Map.Entry))
                return false;
            Map.Entry<?, ?> e = (Map.Entry<?, ?>) o;
            return LoadableConcurrentMap2.this.remove(e.getKey(), e.getValue());
        }
