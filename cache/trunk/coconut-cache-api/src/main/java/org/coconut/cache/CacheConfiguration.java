...
public final class CacheConfiguration<K, V> {
	...
	/**
     * Returns a configuration object that can be used to control what types of
     * events are raised whenever something interesting happens in the cache.
     * 
	...
	/**
     * Returns a service that can be used to configure maximum size, replacement
     * policies, and more for the cache.
     * 
	...
	/**
     * Returns a configuration object that can be used to control how and when
     * elements in the cache expires.
     * 
	...
	/**
     * Returns a configuration object that can be used to control how all the
     * various threads running with coconut.
     * 
	...
	/**
     * Sets the default loggger for this cache. If for some reason the cache or
     * one of its services needs to notify users of some kind of event this
     * logger should be used. a service needs to log information and no special
     * logger has been set for the service. This log should be used.
     * <p>
     * Coconut Caches strives to be very conservertive about what is logged.
     * That is, if it is not log as little as possible. That is, We actually
     * advise running with log at {@link Log.Level.INFO} level even in
     * production.
     * 
     * @param logger
     *            the log to use
     ...
     * and '_' or '-'.
     * <p>
     * If no name is set in the configuration, any cache implementation must
     * generate an (unique) name for the cache. How exactly the name is
	...
	/**
     * Loads a cache configuration from the provided stream, and instantiates a
     * new cache on the basis of the configuration.
     * 
     * @param xmlDoc
