...
@Suite.SuiteClasses( { CacheEntryToPolicy.class, DisableCaching.class, EvictionIsCacheable.class,
        EvictionLRU.class, EvictionMXBean.class, EvictionNoPolicy.class, EvictionService.class,
