...
public class DebugUtil {
    ...
    public static void main(String[] args) throws IOException {
        dump(new byte[]{0, 3, 4, 6, 34, 65, 56, 78, 56, 67, 68, 69, 80, 127, -120, -1, -1}, 0, System.out, 0);
    }
    /**
     ...
     *                is thrown if anything goes wrong writing the data to
     *                stream
    ...
    public static void dump(byte[] data, long offset, OutputStream stream, int index) throws IOException {
