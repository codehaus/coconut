...
public abstract class CharAttribute extends Attribute<Character> implements
    ...
    /**
     * Creates a new CharAttribute with a generated name and a default value of <tt>$defaultValueNoCast</tt>.
     * 
     ...
     * @throws IllegalArgumentException
     *             if $defaultValueNoCast is not a valid value according to {@link #checkValid(char)}
     */
   ...
   /**
    ...
    /**
     * Analogous to {@link #set(AttributeMap, Character)} except taking a primitive char as parameter.
     * 
     * @param attributes
